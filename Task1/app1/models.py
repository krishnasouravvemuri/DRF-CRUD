...
class UserInfo(models.Model):
    ...
    user_lat_passcode_update = models.DateField(null=True)
...
class TeamUsers(models.Model):
    ...
    team_uer_team_role = models.PositiveSmallIntegerField(choices=ROLE_CHOICES)
...
class AllUserInfo_View(models.Model):
    ...
    team_uer_team_role = models.PositiveSmallIntegerField(choices=ROLE_CHOICES, null=True)
